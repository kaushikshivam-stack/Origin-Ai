const ButtonSvg = (white) => (
  <>
    ...
    >
      <path
        fill={white ? "#121212" : "none"}
        stroke={white ? "#121212" : "url(#btn-left)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      <path
        fill={white ? "#121212" : "none"}
        stroke={white ? "#121212" : "url(#btn-right)"} // mentioned in ButtonGradient.jsx
        strokeWidth="2"
